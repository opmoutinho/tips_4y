...
const movement2 = Inputs.movements.movementRecPago
...
describe('Account - Behaviour Operations', () => {
    ...
    it('Tries to see account balance on home page', () => {
        cy.contains(account2)
        cy.contains(movement2.value.toString())
        cy.contains(account1).should('not.exist')
        cy.contains(movement1.value.toString()).should('not.exist')
    })

    it('Tries to see movements on Monthly Summary', () => {
        ...
        cy.get('input[type="submit"]')
          .click()
        cy.contains(movement2.description.toString())
        cy.contains(movement2.payDay.toString())
        cy.contains(account2)
        cy.contains(movement2.value.toString())
        cy.contains(movement1.description.toString())
        cy.contains(movement1.payDay.toString())
        cy.contains(account1)
        cy.contains(movement1.value.toString())
    })
